...
@Component({
  selector: 'app-webinterface-window',
  templateUrl: './webinterface-window.component.html',
  styleUrls: ['./webinterface-window.component.scss']
})
export class WebinterfaceWindowComponent implements OnInit {
